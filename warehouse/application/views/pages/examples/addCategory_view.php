  ...
  <div class="content-wrapper">
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> Category Managerment
      ...
      <div class="row">
        ...
        <div class="col-xs-6 table-responsive form-horizontal">

            <form id="productForm" method="post" action="<?php echo base_url() ?>addcategory/insertCategory">
        ...
        <div class="col-xs-6 table-responsive form-horizontal">
          <div class="form-group">
                  <label class="col-xs-3 control-label">Market price</label>
                  <div class="col-xs-5">
                      <input type="text" class="form-control" name="name" />
                  </div>
              </div>
              ...
              <div class="form-group">
                  <label class="col-xs-3 control-label">QOH</label>
                  <div class="col-xs-5">
                      <input type="text" class="form-control" name="name" />
                  </div>
              </div>
